...
# 모델 + 가중치 저장
model.save("./save/keras51_1_save_weight_1118_model_test02_2.h5")

# 가중치 저장
model.save_weights("./save/keras51_1_save_weight_1118_weight_test02.h5")
...
# 1500/1500 [==============================] - 3s 2ms/step - loss: 0.2705 - acc: 0.9026 - val_loss: 0.3458 - val_acc: 0.8809
# Epoch 30/30
# 1500/1500 [==============================] - 3s 2ms/step - loss: 0.2697 - acc: 0.9032 - val_loss: 0.3388 - val_acc: 0.8825
# 313/313 [==============================] - 1s 2ms/step - loss: 0.3559 - acc: 0.8785
# loss :
#  0.3558720350265503
# accuracy :
#  0.8784999847412109
