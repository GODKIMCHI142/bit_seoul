...
model = load_model("./save/keras50_1_save_model_1118_test01_1.h5")
model.summary()                     
...
modelpath = "./model/keras50_2_load1_model_1118-{epoch:02d}-{val_loss:.4f}.hdf5" 
...
# 1500/1500 [==============================] - 3s 2ms/step - loss: 0.2640 - acc: 0.9031 - val_loss: 0.3505 - val_acc: 0.8788
# Epoch 30/30
# 1500/1500 [==============================] - 3s 2ms/step - loss: 0.2624 - acc: 0.9054 - val_loss: 0.3284 - val_acc: 0.8832
# 313/313 [==============================] - 1s 2ms/step - loss: 0.3618 - acc: 0.8739
# loss :
#  0.36177128553390503
# accuracy :
#  0.8738999962806702
