...
model = Sequential()
model.add(Conv2D(60,(2,2),padding='same',input_shape=(28,28,1))) # 28,28,5
model.add(Conv2D(50,(2,2),padding='valid'))                      # 27,27,5
model.add(Conv2D(40,(3,3)))                                      # 25,25,5
model.add(Conv2D(30,(2,2),strides=2))                            # 12,12,5
model.add(MaxPooling2D(pool_size=2))   # pool_size default : 2  # 6 ,6 ,5
model.add(Flatten())                                            # 180,
...
# 실습2
# 모델 : earlystopping, tensorboard도 넣을것
