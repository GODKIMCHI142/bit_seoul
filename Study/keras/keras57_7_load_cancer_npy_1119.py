...
model1 =  load_model("./save/keras49_mcp_8_A_M_1118.h5")
...
# ==================== LOAD WEIGHT          ==================== #
print("# ==================== LOAD WEIGHT    ==================== #")
model2 =  load_model("./save/keras49_mcp_8_B_M_1118.h5")
model2.compile(loss="binary_crossentropy", optimizer="adam", metrics=["acc"])
model2.load_weights("./save/keras49_mcp_8_W_1118.h5")
...
model3 =  load_model("./model/keras49_mcp_8_MCP_1118-116-0.0265.hdf5")
