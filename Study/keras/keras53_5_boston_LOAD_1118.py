...
model1 =  load_model("./save/keras49_mcp_5_A_M_1118.h5")
...
# ==================== LOAD WEIGHT          ==================== #
print("# ==================== LOAD WEIGHT    ==================== #")
model2 =  load_model("./save/keras49_mcp_5_B_M_1118.h5")
model2.compile(loss="mse", optimizer="adam", metrics=["mae"])
model2.load_weights("./save/keras49_mcp_5_W_1118.h5")
...
model3 =  load_model("./model/keras49_mcp_5_MCP_1118-113-14.0939.hdf5")
