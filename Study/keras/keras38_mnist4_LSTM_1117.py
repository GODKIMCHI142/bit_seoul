...
x_train = x_train.reshape(60000,49,16).astype('float32')/255.
x_test  = x_test.reshape(10000,49,16).astype('float32')/255. # minmax scaler의 효과
...
model = Sequential()
model.add(LSTM(5,activation='relu',input_shape=(49,16)))
...
# model = Sequential()
# model.add(LSTM(10,activation='relu',input_shape=(49,16)))
# model.add(Dense(10,activation='relu')) 
# model.add(Dense(10,activation='relu')) 
# model.add(Dense(10,activation='softmax')) 
