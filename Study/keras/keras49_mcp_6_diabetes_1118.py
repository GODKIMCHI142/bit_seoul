...
model.save("./save/keras49_mcp_6_B_M_1118.h5")
...
modelpath = "./model/keras49_mcp_6_MCP_1118-{epoch:02d}-{val_loss:.4f}.hdf5" 
...
model.save("./save/keras49_mcp_6_A_M_1118.h5")
model.save_weights("./save/keras49_mcp_6_W_1118.h5")
