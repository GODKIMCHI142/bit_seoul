...
# 최적의 params    :  {'n_estimators': 100, 'max_depth': 5, 'learning_rate': 0.1, 'colsample_bytree': 0.9, 'colsample_bylevel': 0.6}
# 최종 정답률     :  0.35145558735358173
# [0.03417147 0.04262338 0.04519458 0.05002284 0.05166468 0.07277754
#  0.07462183 0.13304125 0.20409442 0.29178795]
...
#              reg_alpha=0, reg_lambda=1, scale_pos_weight=1, subsample=1,
#              tree_method='exact', validate_parameters=1, verbosity=None)
# 최적의 params    :  {'n_estimators': 200, 'max_depth': 6, 'learning_rate': 0.3, 'colsample_bytree': 0.6, 'colsample_bylevel': 0.6}
# 최종 정답률     :  0.37278958930690165
# [0.03930973 0.0435467  0.05043951 0.05826094 0.06230061 0.09543835
#  0.11090712 0.14739925 0.17829078 0.214107  ]
