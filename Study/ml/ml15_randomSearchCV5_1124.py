...
# model = SVC()
model = RandomizedSearchCV(RandomForestClassifier(), parameters2, cv=kfold, verbose=2)
...
# 최적의 모델    :  RandomForestClassifier(max_depth=12, min_samples_leaf=3, min_samples_split=10,
#                        n_estimators=200, n_jobs=-1)
# 최적의 매개변수 :  {'n_jobs': -1, 'n_estimators': 200, 'min_samples_split': 10, 'min_samples_leaf': 3, 'max_depth': 12}
# 최종 정답률     :  0.04560181018744691
