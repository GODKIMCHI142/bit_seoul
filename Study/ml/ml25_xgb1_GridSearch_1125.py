...
# 최적의 estimator :  XGBRegressor(base_score=0.5, booster='gbtree', colsample_bylevel=0.7,
...
# {'colsample_bylevel': 0.7, 'colsample_bytree': 0.9, 'learning_rate': 0.3, 
#  'max_depth': 6, 'n_estimators': 300}

# r2 :  0.8906288774615843
